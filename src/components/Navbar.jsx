        ...
        <nav className="bg-gray-950 border-b border-gray-800 px-4 py-3">
            ...
            {open && (
                <div className="md:hidden mt-3 space-y-3 px-2">
                    <Link to="/home" className="block px-3 py-2 rounded-md text-gray-300 hover:bg-gray-800 hover:text-white transition">
                        Home
                    </Link>
                    <Link to="/login" className="block px-3 py-2 rounded-md text-gray-300 hover:bg-gray-800 hover:text-white transition">
                        Login
                    </Link>
                    <p
                        onClick={logout}
                        className="block px-3 py-2 rounded-md text-gray-300 hover:bg-gray-800 hover:text-white transition cursor-pointer"
                    >
                        Logout
                    </p>
                </div>
